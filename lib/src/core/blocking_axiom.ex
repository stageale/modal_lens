defmodule Src.Core.BlockingAxiom do
  @moduledoc """
  Generation of Isabelle/HOL blocking axioms for finite Nitpick models.

  A blocking axiom excludes one concrete finite countermodel. It is useful for iterative exploration,
  but it should not be confused with a general modal frame axiom schema such as seriality, reflexivity, transitivity or euclideanness.
  """
