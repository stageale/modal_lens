...
(* Automatically generated blocking axiom 1. *)
axiomatization where
  ax_Chisholm_model_001: "\<not>(
      \<exists>u1 u2.
      distinct [u1, u2] \<and>
...
(* Automatically generated blocking axiom 2. *)
axiomatization where
  ax_Chisholm_model_002: "\<not>(
      \<exists>u1 u2.
      distinct [u1, u2] \<and>
      (\<forall>x. x = u1 \<or> x = u2) \<and>
      (R u1 u1) \<and>
